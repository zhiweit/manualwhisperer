...
const SelectTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <SelectPrimitive.Trigger
      class={cn(
        "flex h-10 w-full items-center justify-between bg-transparent px-3 py-2 text-sm placeholder:text-muted-foreground rounded-md disabled:cursor-not-allowed disabled:opacity-50",
        local.class
      )}
      {...others}
    >
